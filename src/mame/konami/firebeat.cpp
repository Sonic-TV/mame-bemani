...
static INPUT_PORTS_START(bm3)
	...
	PORT_BIT( 0xff, 0x00, IPT_POSITIONAL ) PORT_PLAYER(1) PORT_NAME("1P Table (Analog)") PORT_WRAPS PORT_MINMAX(0x00,0xff) PORT_SENSITIVITY(100) PORT_KEYDELTA(10)
	...
	PORT_BIT( 0xff, 0x00, IPT_POSITIONAL ) PORT_PLAYER(2) PORT_NAME("2P Table (Analog)") PORT_WRAPS PORT_MINMAX(0x00,0xff) PORT_SENSITIVITY(100) PORT_KEYDELTA(10)
...
GAME( 2002, bm3final, 0, firebeat_bm3, bm3, firebeat_bm3_state, init_bm3, ROT0, "Konami", "Beatmania III The Final", MACHINE_IMPERFECT_SOUND )

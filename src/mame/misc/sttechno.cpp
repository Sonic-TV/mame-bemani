...
class sttechno_shambrosa_hack_state : public sttechno_state
{
public:
	sttechno_shambrosa_hack_state(const machine_config &mconfig, device_type type, const char *tag)
		: sttechno_state(mconfig, type, tag)
	{
	}
...
void sttechno_shambrosa_hack_state::machine_start()
{
	sttechno_state::machine_start();

	// HACK: Load pgx.bin (V1.00K) from the CD. This build of the game expects to be running
	// out of 0x200000 so I assume there was a more generic boot ROM used for V1.00K.
	constexpr int prog_start_lba = 1286;
	constexpr int prog_lba_len = 52;
	constexpr int prog_start_addr = 0x223c00;
	...
	for (int i = 0; i < prog_lba_len; i++) {
		...
		for (int j = 0; j < 2048; j++) {
			m_maincpu->space().write_byte(BYTE_XOR_LE(prog_start_addr + (2048 * i) + j), temp_buffer[j]);
		}
	}
}
...
ROM_START( shambrosa )
	ROM_REGION(0x80000, "maincpu", 0)
	ROM_LOAD16_WORD_SWAP( "g112 v1.01.u46", 0x00000, 0x80000, CRC(6e13bcde) SHA1(189b0052083717030ca868b95b9d43e1faaf9695) )
	// Patch in the vectors etc for v1.00
	ROM_FILL(0x000, 1, 0x00)
	ROM_FILL(0x001, 1, 0x24)
	ROM_FILL(0x002, 1, 0x00)
	ROM_FILL(0x003, 1, 0x00)
	ROM_FILL(0x004, 1, 0x00)
	ROM_FILL(0x005, 1, 0x22)
	ROM_FILL(0x006, 1, 0x40)
	ROM_FILL(0x007, 1, 0x64)
	ROM_FILL(0x008, 1, 0x00)
	ROM_FILL(0x009, 1, 0x22)
	ROM_FILL(0x00a, 1, 0x3c)
	ROM_FILL(0x00b, 1, 0xc0)
	ROM_FILL(0x00c, 1, 0x00)
	ROM_FILL(0x00d, 1, 0x22)
	ROM_FILL(0x00e, 1, 0x3c)
	ROM_FILL(0x00f, 1, 0xd0)
	ROM_FILL(0x010, 1, 0x00)
	ROM_FILL(0x011, 1, 0x22)
	ROM_FILL(0x012, 1, 0x3c)
	ROM_FILL(0x013, 1, 0xe0)
	ROM_FILL(0x014, 1, 0x00)
	ROM_FILL(0x015, 1, 0x22)
	ROM_FILL(0x016, 1, 0x3c)
	ROM_FILL(0x017, 1, 0xf0)
	ROM_FILL(0x018, 1, 0x00)
	ROM_FILL(0x019, 1, 0x22)
	ROM_FILL(0x01a, 1, 0x3d)
	ROM_FILL(0x01b, 1, 0x00)
	ROM_FILL(0x01c, 1, 0x00)
	ROM_FILL(0x01d, 1, 0x22)
	ROM_FILL(0x01e, 1, 0x3d)
	ROM_FILL(0x01f, 1, 0x10)
	ROM_FILL(0x020, 1, 0x00)
	ROM_FILL(0x021, 1, 0x22)
	ROM_FILL(0x022, 1, 0x3d)
	ROM_FILL(0x023, 1, 0x20)
	ROM_FILL(0x024, 1, 0x00)
	ROM_FILL(0x025, 1, 0x22)
	ROM_FILL(0x026, 1, 0x3d)
	ROM_FILL(0x027, 1, 0x30)
	ROM_FILL(0x028, 1, 0x00)
	ROM_FILL(0x029, 1, 0x22)
	ROM_FILL(0x02a, 1, 0x3d)
	ROM_FILL(0x02b, 1, 0x40)
	ROM_FILL(0x02c, 1, 0x00)
	ROM_FILL(0x02d, 1, 0x22)
	ROM_FILL(0x02e, 1, 0x3d)
	ROM_FILL(0x02f, 1, 0x50)
	ROM_FILL(0x030, 1, 0x00)
	ROM_FILL(0x031, 1, 0x22)
	ROM_FILL(0x032, 1, 0x3e)
	ROM_FILL(0x033, 1, 0xf0)
	ROM_FILL(0x034, 1, 0x00)
	ROM_FILL(0x035, 1, 0x22)
	ROM_FILL(0x036, 1, 0x3e)
	ROM_FILL(0x037, 1, 0xf0)
	ROM_FILL(0x038, 1, 0x00)
	ROM_FILL(0x039, 1, 0x22)
	ROM_FILL(0x03a, 1, 0x3e)
	ROM_FILL(0x03b, 1, 0xf0)
	ROM_FILL(0x03c, 1, 0x00)
	ROM_FILL(0x03d, 1, 0x22)
	ROM_FILL(0x03e, 1, 0x3d)
	ROM_FILL(0x03f, 1, 0x60)
	ROM_FILL(0x040, 1, 0x00)
	ROM_FILL(0x041, 1, 0x22)
	ROM_FILL(0x042, 1, 0x3e)
	ROM_FILL(0x043, 1, 0xf0)
	ROM_FILL(0x044, 1, 0x00)
	ROM_FILL(0x045, 1, 0x22)
	ROM_FILL(0x046, 1, 0x3e)
	ROM_FILL(0x047, 1, 0xf0)
	ROM_FILL(0x048, 1, 0x00)
	ROM_FILL(0x049, 1, 0x22)
	ROM_FILL(0x04a, 1, 0x3e)
	ROM_FILL(0x04b, 1, 0xf0)
	ROM_FILL(0x04c, 1, 0x00)
	ROM_FILL(0x04d, 1, 0x22)
	ROM_FILL(0x04e, 1, 0x3e)
	ROM_FILL(0x04f, 1, 0xf0)
	ROM_FILL(0x050, 1, 0x00)
	ROM_FILL(0x051, 1, 0x22)
	ROM_FILL(0x052, 1, 0x3e)
	ROM_FILL(0x053, 1, 0xf0)
	ROM_FILL(0x054, 1, 0x00)
	ROM_FILL(0x055, 1, 0x22)
	ROM_FILL(0x056, 1, 0x3e)
	ROM_FILL(0x057, 1, 0xf0)
	ROM_FILL(0x058, 1, 0x00)
	ROM_FILL(0x059, 1, 0x22)
	ROM_FILL(0x05a, 1, 0x3e)
	ROM_FILL(0x05b, 1, 0xf0)
	ROM_FILL(0x05c, 1, 0x00)
	ROM_FILL(0x05d, 1, 0x22)
	ROM_FILL(0x05e, 1, 0x3e)
	ROM_FILL(0x05f, 1, 0xf0)
	ROM_FILL(0x060, 1, 0x00)
	ROM_FILL(0x061, 1, 0x22)
	ROM_FILL(0x062, 1, 0x3d)
	ROM_FILL(0x063, 1, 0x70)
	ROM_FILL(0x064, 1, 0x00)
	ROM_FILL(0x065, 1, 0x22)
	ROM_FILL(0x066, 1, 0x3d)
	ROM_FILL(0x067, 1, 0x80)
	ROM_FILL(0x068, 1, 0x00)
	ROM_FILL(0x069, 1, 0x22)
	ROM_FILL(0x06a, 1, 0x40)
	ROM_FILL(0x06b, 1, 0x14)
	ROM_FILL(0x06c, 1, 0x00)
	ROM_FILL(0x06d, 1, 0x22)
	ROM_FILL(0x06e, 1, 0x3d)
	ROM_FILL(0x06f, 1, 0xa0)
	ROM_FILL(0x070, 1, 0x00)
	ROM_FILL(0x071, 1, 0x22)
	ROM_FILL(0x072, 1, 0x3f)
	ROM_FILL(0x073, 1, 0xec)
	ROM_FILL(0x074, 1, 0x00)
	ROM_FILL(0x075, 1, 0x22)
	ROM_FILL(0x076, 1, 0x3f)
	ROM_FILL(0x077, 1, 0xca)
	ROM_FILL(0x078, 1, 0x00)
	ROM_FILL(0x079, 1, 0x22)
	ROM_FILL(0x07a, 1, 0x3f)
	ROM_FILL(0x07b, 1, 0xa2)
	ROM_FILL(0x07c, 1, 0x00)
	ROM_FILL(0x07d, 1, 0x22)
	ROM_FILL(0x07e, 1, 0x3d)
	ROM_FILL(0x07f, 1, 0xe0)
	ROM_FILL(0x080, 1, 0x00)
	ROM_FILL(0x081, 1, 0x22)
	ROM_FILL(0x082, 1, 0x41)
	ROM_FILL(0x083, 1, 0x78)
	ROM_FILL(0x084, 1, 0x00)
	ROM_FILL(0x085, 1, 0x22)
	ROM_FILL(0x086, 1, 0x3e)
	ROM_FILL(0x087, 1, 0x00)
	ROM_FILL(0x088, 1, 0x00)
	ROM_FILL(0x089, 1, 0x22)
	ROM_FILL(0x08a, 1, 0x3e)
	ROM_FILL(0x08b, 1, 0x10)
	ROM_FILL(0x08c, 1, 0x00)
	ROM_FILL(0x08d, 1, 0x22)
	ROM_FILL(0x08e, 1, 0x3e)
	ROM_FILL(0x08f, 1, 0x20)
	ROM_FILL(0x090, 1, 0x00)
	ROM_FILL(0x091, 1, 0x22)
	ROM_FILL(0x092, 1, 0x3e)
	ROM_FILL(0x093, 1, 0x30)
	ROM_FILL(0x094, 1, 0x00)
	ROM_FILL(0x095, 1, 0x22)
	ROM_FILL(0x096, 1, 0x3e)
	ROM_FILL(0x097, 1, 0x40)
	ROM_FILL(0x098, 1, 0x00)
	ROM_FILL(0x099, 1, 0x22)
	ROM_FILL(0x09a, 1, 0x3e)
	ROM_FILL(0x09b, 1, 0x50)
	ROM_FILL(0x09c, 1, 0x00)
	ROM_FILL(0x09d, 1, 0x22)
	ROM_FILL(0x09e, 1, 0x3e)
	ROM_FILL(0x09f, 1, 0x60)
	ROM_FILL(0x0a0, 1, 0x00)
	ROM_FILL(0x0a1, 1, 0x22)
	ROM_FILL(0x0a2, 1, 0x3e)
	ROM_FILL(0x0a3, 1, 0x70)
	ROM_FILL(0x0a4, 1, 0x00)
	ROM_FILL(0x0a5, 1, 0x22)
	ROM_FILL(0x0a6, 1, 0x3e)
	ROM_FILL(0x0a7, 1, 0x80)
	ROM_FILL(0x0a8, 1, 0x00)
	ROM_FILL(0x0a9, 1, 0x22)
	ROM_FILL(0x0aa, 1, 0x3e)
	ROM_FILL(0x0ab, 1, 0x90)
	ROM_FILL(0x0ac, 1, 0x00)
	ROM_FILL(0x0ad, 1, 0x22)
	ROM_FILL(0x0ae, 1, 0x3e)
	ROM_FILL(0x0af, 1, 0xa0)
	ROM_FILL(0x0b0, 1, 0x00)
	ROM_FILL(0x0b1, 1, 0x22)
	ROM_FILL(0x0b2, 1, 0x3e)
	ROM_FILL(0x0b3, 1, 0xb0)
	ROM_FILL(0x0b4, 1, 0x00)
	ROM_FILL(0x0b5, 1, 0x22)
	ROM_FILL(0x0b6, 1, 0x3e)
	ROM_FILL(0x0b7, 1, 0xc0)
	ROM_FILL(0x0b8, 1, 0x00)
	ROM_FILL(0x0b9, 1, 0x22)
	ROM_FILL(0x0ba, 1, 0x3e)
	ROM_FILL(0x0bb, 1, 0xd0)
	ROM_FILL(0x0bc, 1, 0x00)
	ROM_FILL(0x0bd, 1, 0x22)
	ROM_FILL(0x0be, 1, 0x3e)
	ROM_FILL(0x0bf, 1, 0xe0)
	ROM_FILL(0x0c0, 1, 0x46)
	ROM_FILL(0x0c1, 1, 0xfc)
	ROM_FILL(0x0c2, 1, 0x27)
	ROM_FILL(0x0c3, 1, 0x00)
	ROM_FILL(0x0c4, 1, 0x33)
	ROM_FILL(0x0c5, 1, 0xfc)
	ROM_FILL(0x0c6, 1, 0x00)
	ROM_FILL(0x0c7, 1, 0x02)
	ROM_FILL(0x0c8, 1, 0x00)
	ROM_FILL(0x0c9, 1, 0x20)
	ROM_FILL(0x0ca, 1, 0x04)
	ROM_FILL(0x0cb, 1, 0x88)
	ROM_FILL(0x0cc, 1, 0x60)
	ROM_FILL(0x0cd, 1, 0x00)
	ROM_FILL(0x0ce, 1, 0x02)
	ROM_FILL(0x0cf, 1, 0x2e)
	ROM_FILL(0x0d0, 1, 0x46)
	ROM_FILL(0x0d1, 1, 0xfc)
	ROM_FILL(0x0d2, 1, 0x27)
	ROM_FILL(0x0d3, 1, 0x00)
	ROM_FILL(0x0d4, 1, 0x33)
	ROM_FILL(0x0d5, 1, 0xfc)
	ROM_FILL(0x0d6, 1, 0x00)
	ROM_FILL(0x0d7, 1, 0x03)
	ROM_FILL(0x0d8, 1, 0x00)
	ROM_FILL(0x0d9, 1, 0x20)
	ROM_FILL(0x0da, 1, 0x04)
	ROM_FILL(0x0db, 1, 0x88)
	ROM_FILL(0x0dc, 1, 0x60)
	ROM_FILL(0x0dd, 1, 0x00)
	ROM_FILL(0x0de, 1, 0x02)
	ROM_FILL(0x0df, 1, 0x1e)
	ROM_FILL(0x0e0, 1, 0x46)
	ROM_FILL(0x0e1, 1, 0xfc)
	ROM_FILL(0x0e2, 1, 0x27)
	ROM_FILL(0x0e3, 1, 0x00)
	ROM_FILL(0x0e4, 1, 0x33)
	ROM_FILL(0x0e5, 1, 0xfc)
	ROM_FILL(0x0e6, 1, 0x00)
	ROM_FILL(0x0e7, 1, 0x04)
	ROM_FILL(0x0e8, 1, 0x00)
	ROM_FILL(0x0e9, 1, 0x20)
	ROM_FILL(0x0ea, 1, 0x04)
	ROM_FILL(0x0eb, 1, 0x88)
	ROM_FILL(0x0ec, 1, 0x60)
	ROM_FILL(0x0ed, 1, 0x00)
	ROM_FILL(0x0ee, 1, 0x02)
	ROM_FILL(0x0ef, 1, 0x0e)
	ROM_FILL(0x0f0, 1, 0x46)
	ROM_FILL(0x0f1, 1, 0xfc)
	ROM_FILL(0x0f2, 1, 0x27)
	ROM_FILL(0x0f3, 1, 0x00)
	ROM_FILL(0x0f4, 1, 0x33)
	ROM_FILL(0x0f5, 1, 0xfc)
	ROM_FILL(0x0f6, 1, 0x00)
	ROM_FILL(0x0f7, 1, 0x05)
	ROM_FILL(0x0f8, 1, 0x00)
	ROM_FILL(0x0f9, 1, 0x20)
	ROM_FILL(0x0fa, 1, 0x04)
	ROM_FILL(0x0fb, 1, 0x88)
	ROM_FILL(0x0fc, 1, 0x60)
	ROM_FILL(0x0fd, 1, 0x00)
	ROM_FILL(0x0fe, 1, 0x01)
	ROM_FILL(0x0ff, 1, 0xfe)
...
GAME( 2003, shambrosa, shambros, shambros, shambros, sttechno_shambrosa_hack_state, empty_init, ROT0, "Kato's", "Shamisen Brothers Vol 1 (V1.00K)", MACHINE_IMPERFECT_TIMING )
